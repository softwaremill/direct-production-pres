      ...
      <Row className="h-100">
        <Fade appear in>
          <Container className="d-flex flex-column justify-content-start align-items-center">
            ...
            <p>
              If you are interested in how Directdemo works,
              <br />
              you can browse the{' '}
              <a href="http://softwaremill.github.io/directdemo/" target="blank">
                Documentation
              </a>{' '}
              or{' '}
              <a
                href="https://github.com/softwaremill/directdemo"
                target="blank"
              >
                Source code
              </a>
